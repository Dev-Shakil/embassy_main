...
<body>
  ...
  <section id="hero" class=" align-items-center">
    <div class="container d-flex justify-content-evenly">
      ...
      <button type="button" class="btn"><a href="{{route('user/embassy_list')}}"> Embassy List</a></button>
      ...
      {{-- <a href="{{route('user/update')}}" class="btn btn-primary">Update</a> --}}
    </div>
    @if(session('success'))
      <script>
    ...
    <div class="container mt-4">
      <caption class="fw-bold text-center">Candidates</caption>
      <table class="table table-bordered border-primary" id="candidatetable">
        <thead>
          <tr>
            ...
            <th scope="col">VISA/ID Number</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('user/visaadd', ['id' => $candidate->id]) }}" target="_blank">Add Visa</a>
              <a href="{{ route('user/edit', ['id' => $candidate->id]) }}" target="_blank">Edit</a>
              <a href="{{ route('user/print', ['id' => $candidate->id]) }}" target="_blank">Print</a>
            </td>
          </tr>
          @endforeach
        </tbody>
